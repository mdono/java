...
public class Multiplicacion {
    public Multiplicacion() {
        System.out.println("ingresando en las operaciones de multiplicación");
        String cadena;
        int valor1, valor2 = 0;
        
        cadena = JOptionPane.showInputDialog("Para realizar la multiplicación debes de ingresar 2 valores\nIngresa tu primer valor entero");
