...
public class Tuna extends JFrame {
    ...
    public Tuna() {
        ...
        ElManejador instacia = new ElManejador();
        campo1.addActionListener(instacia);
        campo2.addActionListener(instacia);
        campo3.addActionListener(instacia);
        campo4.addActionListener(instacia);
    }
